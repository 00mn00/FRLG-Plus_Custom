...
enum
{
    ...
    HELP_TERM_NUZLOCKE_SHINY_CLAUSE,
    HELP_TERM_LEVELCAP,
	HELP_TERM_LEVELRELAXED,
    HELP_TERM_LEVELSTRICT,
    HELP_TERM_LEVELHARSH,
    HELP_TERM_IV_CALC,
    HELP_TERM_EV_CALC,
    HELP_TERM_NO_PMC,
    HELP_TERM_NO_IH,
    HELP_TERM_NO_IH_BAG,
    HELP_TERM_NO_IH_BATTLE,
    HELP_TERM_NO_IH_BOTH,
    HELP_TERM_NO_EH,
    HELP_TERM_FORCEDSTYLE,
...
static const u8 *const sHelpSystemTermTextPtrs[] = {
    ...
    [HELP_TERM_NUZLOCKE_SHINY_CLAUSE] = Help_Text_Nuzlocke_ShinyClause,
    [HELP_TERM_LEVELCAP]       = Help_Text_LevelCap,
	[HELP_TERM_LEVELRELAXED]   = Help_Text_LevelCapRelaxed,
    [HELP_TERM_LEVELSTRICT]    = Help_Text_LevelCapStrict,
    [HELP_TERM_LEVELHARSH]     = Help_Text_LevelCapHarsh,
    [HELP_TERM_IV_CALC]        = Help_Text_IvCalc,
    [HELP_TERM_EV_CALC]        = Help_Text_EvCalc,
    [HELP_TERM_NO_PMC]         = Help_Text_NoFreeHeals,
    [HELP_TERM_NO_IH]          = Help_Text_NoIH,
    [HELP_TERM_NO_IH_BAG]      = Help_Text_NoIHBag,
    [HELP_TERM_NO_IH_BATTLE]   = Help_Text_NoIHBattle,
    [HELP_TERM_NO_IH_BOTH]     = Help_Text_NoIHBoth,
    [HELP_TERM_NO_EH]          = Help_Text_NoEH,
    [HELP_TERM_FORCEDSTYLE]    = Help_Text_ForcedStyle,
...
static const u8 *const sHelpSystemTermDefinitionsTextPtrs[] = {
    ...
    [HELP_TERM_NUZLOCKE_SHINY_CLAUSE] = Help_Text_DefineNuzlocke_ShinyClause,
    [HELP_TERM_LEVELCAP]       = Help_Text_DefineLevelCap,
	[HELP_TERM_LEVELRELAXED]   = Help_Text_DefineLevelCapRelaxed,
    [HELP_TERM_LEVELSTRICT]    = Help_Text_DefineLevelCapStrict,
    [HELP_TERM_LEVELHARSH]     = Help_Text_DefineLevelCapHarsh,
    ...
    [HELP_TERM_NO_IH]          = Help_Text_DefineNoIH,
    [HELP_TERM_NO_IH_BAG]      = Help_Text_DefineNoIHBag,
    [HELP_TERM_NO_IH_BATTLE]   = Help_Text_DefineNoIHBattle,
    [HELP_TERM_NO_IH_BOTH]     = Help_Text_DefineNoIHBoth,
    [HELP_TERM_NO_EH]          = Help_Text_DefineNoEH,
    [HELP_TERM_FORCEDSTYLE]    = Help_Text_DefineForcedStyle,
