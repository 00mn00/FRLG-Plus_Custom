...
static const u8 sText_TakeItemCaptured[] = _("{B_OPPONENT_MON1_NAME} is holding an item!\pWould you like to place the\n{STR_VAR_1} in your BAG?");
static const u8 sText_ItemTaken[] = _("The {STR_VAR_1} was placed\nin your BAG.\p");
