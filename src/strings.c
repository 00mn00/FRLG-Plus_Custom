...
const u8 gText_Tm13_4000Coins[] = _("TM {NO}13{CLEAR_TO 0x48}{SMALL}4,000 COINS");
const u8 gText_Tm23_3500Coins[] = _("TM {NO}23{CLEAR_TO 0x48}{SMALL}3,500 COINS");
const u8 gText_Tm24_4000Coins[] = _("TM {NO}24{CLEAR_TO 0x48}{SMALL}4,000 COINS");
const u8 gText_Tm30_4500Coins[] = _("TM {NO}30{CLEAR_TO 0x48}{SMALL}4,500 COINS");
const u8 gText_Tm35_4000Coins[] = _("TM {NO}35{CLEAR_TO 0x48}{SMALL}4,000 COINS");
