...
const u8 gText_NoUse[] = _("Can't use!");
...
const u8 gText_PokemonCenter[] = _("POKéCENTER");
...
const u8 gText_MoveOkBack[] = _("{DPAD_ANY}MOVE {SELECT_BUTTON}CASE {A_BUTTON}OK {B_BUTTON}BACK");
...
const u8 gText_BattleTowerWinStraight[] = _("W/      &      STRAIGHT");
...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a POKéCENTER,\nprotecting the exhausted and fainted\nPOKéMON from further harm‥\p");
