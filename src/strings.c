...
const u8 gText_ContinueLearningMove2[] = _("Continue trying to teach\n{STR_VAR_2}?");
...
const u8 gText_ContinueLearningMove[] = _("Continue learning {STR_VAR_2}?");
...
const u8 gText_ContinueTryingToTeachNewMove[] = _("Continue trying to teach a new\nmove to {STR_VAR_1}?");
