...
const u8 gOtherText_Cancel[] = _("CANCEL");
...
const u8 gText_Default[] = _("DEFAULT");
const u8 gText_Version[] = _("GAME VERSION");
const u8 gText_FireredVersion[] = _("FIRERED");
const u8 gText_LeafgreenVersion[] = _("LEAFGREEN");
const u8 gText_Difficulty[] = _("DIFFICULTY MODE");
...
const u8 gText_Nuzlocke_ShinyOn[] = _("SHINY CLAUSE ON");
const u8 gText_Nuzlocke_ShinyOff[] = _("SHINY CLAUSE OFF");
const u8 gText_LevelCap[] = _("LEVEL CAP");
const u8 gText_StrictLevelCap[] = _("STRICT");
const u8 gText_HarshLevelCap[] = _("HARSH");
const u8 gText_RelaxedLevelCap[] = _("RELAXED");
const u8 gText_ExpMod[] = _("EXP. MODIFIER");
const u8 gText_ExpModOne[] = _("1×");
const u8 gText_ExpModDouble[] = _("2×");
const u8 gText_ExpModQuad[] = _("4×");
...
const u8 gText_NoPMC[] = _("FREE HEALS");
const u8 gText_NoPMCOn[] = _("PKMN CTR DISABLED");
const u8 gText_NoIH[] = _("PLAYER HEALS");
const u8 gText_NoIHBag[] = _("FLD USE DISABLED");
const u8 gText_NoIHBattle[] = _("BTL USE DISABLED");
const u8 gText_NoIHBoth[] = _("FLD/BTL DISABLED");
const u8 gText_NoEH[] = _("ENEMY HEALS");
const u8 gText_ForcedStyle[] = _("BATTLE STYLE");
const u8 gText_ForcedStyle2[] = _("FORCE “SET” MODE");
