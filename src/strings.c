...
const u8 gStartMenu_TimeBoxClock[] = _("{STR_VAR_1}:{STR_VAR_2}");
const u8 gStartMenu_TimeBoxClock2[] = _("CLOCK: {STR_VAR_1}:{STR_VAR_2}");
...
const u8 gUnknown_84162A9[] = _("STEPS: {STR_VAR_1}/{STR_VAR_2}\nBALLS: {STR_VAR_3}/30");
