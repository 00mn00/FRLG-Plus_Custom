...
extern const u8 gOtherText_Cancel[];
...
extern const u8 gText_Nuzlocke_ShinyOn[];
extern const u8 gText_Nuzlocke_ShinyOff[];
extern const u8 gText_LevelCap[];
extern const u8 gText_StrictLevelCap[];
extern const u8 gText_HarshLevelCap[];
extern const u8 gText_RelaxedLevelCap[];
extern const u8 gText_ExpMod[];
extern const u8 gText_ExpModZero[];
extern const u8 gText_ExpModHalf[];
extern const u8 gText_ExpModOne[];
extern const u8 gText_ExpModDouble[];
extern const u8 gText_ExpModQuad[];
...
extern const u8 gText_NoPMCOn[];
extern const u8 gText_NoIH[];
extern const u8 gText_NoIHBag[];
extern const u8 gText_NoIHBattle[];
extern const u8 gText_NoIHBoth[];
extern const u8 gText_NoEH[];
extern const u8 gText_ForcedStyle[];
extern const u8 gText_ForcedStyle2[];
