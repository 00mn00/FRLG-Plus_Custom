...
extern const u8 Help_Text_DefineLevelCapRelaxed[];
extern const u8 Help_Text_DefineLevelCapStrict[];
extern const u8 Help_Text_DefineLevelCapHarsh[];
...
extern const u8 Help_Text_DefineNuzlocke_ShinyClause[];
extern const u8 Help_Text_DefineNoFreeHeals[];
extern const u8 Help_Text_DefineNoIH[];
